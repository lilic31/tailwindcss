...
<head>
    ...
    <title>Construction d'une navbar</title>
    <style>
...
<header class="px-6 lg:px-16 bg-white py-2 lg:py-0 flex flex-wrap items-center">
    ...
    <label for="menu-toggle" class="cursor-pointer lg:hidden block">
        <svg class="fill-current text-gray-900" xmlns="http://www.w3.org/2000/svg" width="32" height="36" viewBox="0 0 20 20">
            <title>Menu</title>
    ...
    <div class="hidden lg:flex lg:items-center lg:w-auto w-full" id="menu">
        ...
        <a href="#" class="lg:ml-4 flex items-center justify-start lg:mb-0 mb-4 cursor-pointer ">
            <img src="https://pbs.twimg.com/profile_images/1128143121475342337/e8tkhRaz_normal.jpg" alt="Eric ALIBERT" class="rounded-full w-10 h-10 border-2 border-transparent hover:border-indigo-400">
        </a>
    </div>
